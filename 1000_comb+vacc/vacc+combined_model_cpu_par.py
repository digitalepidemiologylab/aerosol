...
#    # SECTION OF CODE ON ASSORTATIVITY ...temporary COMMENTED 
#    for i in individuals:
#        G_cpr.add_node(i,vax=0)
#    
#    for i in vac:
#        G_cpr.add_node(i,vax=1)
#    
#    cur_assort = networkx.attribute_assortativity_coefficient(G_cpr,'vax')
#    
#    for i in range(0, 1000):
#        
#        id1 = random.choice(individuals)
#        id2 = random.choice(individuals)
#        
#        (G_cpr.node[id1]['vax'],G_cpr.node[id2]['vax']) = (
#         G_cpr.node[id2]['vax'],G_cpr.node[id1]['vax'])
#        
#        new_assort = networkx.attribute_assortativity_coefficient(G_cpr,'vax')
#        
#        if abs(new_assort - assort) < 0.005:
#            cur_assort = new_assort
#            break
#        
#        if abs(new_assort - assort) >= abs(cur_assort - assort):
#            (G_cpr.node[id1]['vax'],G_cpr.node[id2]['vax']) = (
#             G_cpr.node[id2]['vax'],G_cpr.node[id1]['vax'])
#        else:
#            cur_assort = new_assort
...
#        print "---> RUN", run
        ...
        #we're not printing the next2 quantities
